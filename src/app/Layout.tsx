...
function Layout() {
  return (
    <div className="grid h-screen grid-cols-1 lg:grid-cols-15 xl:grid-cols-6">
      ...
      <div className="order-1 col-span-1 mt-18 overflow-y-auto lg:order-2 lg:col-span-14 lg:mt-0 xl:col-span-5">
        <Outlet />
      </div>
    </div>
  );
