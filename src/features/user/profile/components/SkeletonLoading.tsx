    ...
    <div className="container flex max-w-4xl flex-col justify-center gap-4 px-4 py-3 pb-20 lg:py-10">
      <div className="mx-auto">
        <div className="flex w-full items-center gap-10 lg:justify-between">
          {/* image */}
          <div className="h-20 w-20 shrink-0 animate-pulse rounded-full bg-gray-500 lg:h-30 lg:w-30"></div>

          {/* user details */}
          <div className="flex flex-1 flex-col gap-2 lg:gap-5">
            {/* user info and interactions */}
            <div className="flex items-center gap-5">
              <div className="h-4 w-20 animate-pulse rounded-full bg-gray-500"></div>
              <div className="hidden h-6 w-20 animate-pulse rounded-md bg-gray-500 lg:flex"></div>
            </div>

            {/* responsive follow button */}
            <div className="flex h-6 w-20 animate-pulse self-start rounded-md bg-gray-500 lg:hidden"></div>

            {/* followers, posts and following counts */}
            <div className="flex items-center gap-5 lg:gap-10">
              <div className="flex items-center gap-2">
                <div className="h-4 w-4 animate-pulse rounded-md bg-gray-500"></div>
      ...
      <div className="grid grid-cols-2">
        <div className="flex w-full items-center justify-center">
          <div className="h-10 w-10 animate-pulse rounded-md bg-gray-500"></div>
        </div>
        ...
        {Array.from({ length: 6 }).map((_, i) => (
          <div key={i}>
            ...
            <div className="relative aspect-square">
              <div className="aspect-square animate-pulse bg-gray-500 object-cover" />
            </div>
          </div>
        ))}
      </div>
